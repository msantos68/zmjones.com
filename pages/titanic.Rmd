...
titanic3$class_sex <- factor(apply(titanic3, 1,
...
```{r, titanic-separation-glm, fig.width = 8.5, fig.height = 1.5, fig.path = "../static/posts/", fig.cap = "", dpi = 300}
...
```{r, titanic-survival-glm, fig.width = 8.5, fig.height = 6, fig.path = "../static/posts/", fig.cap = "", dpi = 300}
...
```{r, titanic-separation-gam, fig.width = 8.5, fig.height = 1.5, fig.path = "../static/posts/", fig.cap = "", dpi = 300}
...
and $\hat{\phi}$ and $\hat{\lambda}$ are estimated in the model. I simulate 1000 replicates of $\beta$s, multiply that by the linear predictors matrix, take quantiles to find the mean and the 95% credible interval, and then transform to the response scale.

```{r, titanic-survival-np, fig.width = 8.5, fig.height = 6, fig.path = "../static/posts/", fig.cap = "", dpi = 300}
sim.data <- expand.grid(sex = c("male", "female"), sibsp = 0,
                        age = seq(1, 80), pclass = c("1st", "2nd", "3rd"))
